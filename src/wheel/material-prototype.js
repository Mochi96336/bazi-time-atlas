...
const FRAGMENT_SHADER = [
  ...
  "  float nebulaLightAlpha = smoothstep(0.57, 0.76, nebula) * 0.026;",
  "  float nebulaDarkAlpha = smoothstep(0.58, 0.77, 1.0 - nebula) * 0.032;",
  "  vec3 nebulaLightTint = vec3(0.22, 0.28, 0.46);",
  "  vec3 nebulaDarkTint = vec3(0.006, 0.010, 0.020);",
  "  float nebulaAlpha = nebulaLightAlpha + nebulaDarkAlpha;",
  "  float overlayAlpha = edgeMask * clamp(specularAlpha + microAlpha + nebulaAlpha, 0.0, 0.060);",
