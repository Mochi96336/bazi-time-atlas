...
const FRAGMENT_SHADER = [
  ...
  "  vec3 brassLight = vec3(0.387, 0.295, 0.174);",
  "  vec3 brassMid = vec3(0.333, 0.243, 0.139);",
  "  vec3 brassDark = vec3(0.173, 0.111, 0.060);",
  ...
  "  return mix(body, vec3(0.961, 0.878, 0.710), warmCatch * 0.008);",
  "}",
  "",
  ...
  "  float nebulaLightAlpha = smoothstep(0.57, 0.76, nebula) * 0.010;",
  "  float nebulaDarkAlpha = smoothstep(0.58, 0.77, 1.0 - nebula) * 0.012;",
  "  vec3 nebulaLightTint = vec3(0.18, 0.22, 0.34);",
  "  vec3 nebulaDarkTint = vec3(0.010, 0.014, 0.024);",
  "  float nebulaAlpha = nebulaLightAlpha + nebulaDarkAlpha;",
  "  float overlayAlpha = edgeMask * clamp(specularAlpha + microAlpha + nebulaAlpha, 0.0, 0.038);",
