...
const FRAGMENT_SHADER = [
  ...
  "  vec3 brassLight = vec3(0.355, 0.283, 0.208);",
  "  vec3 brassMid = vec3(0.304, 0.242, 0.179);",
  "  vec3 brassDark = vec3(0.150, 0.103, 0.072);",
  ...
  "  return mix(body, vec3(0.920, 0.890, 0.810), warmCatch * 0.008);",
  "}",
  "",
  ...
  "  vec3 reflectionTint = vec3(0.38, 0.43, 0.53);",
  "  vec3 microLightTint = vec3(0.31, 0.36, 0.47);",
  "  vec3 microDarkTint = vec3(0.020, 0.025, 0.036);",
  "  float specularAlpha = clamp(specular * environmentResponse * 0.20, 0.0, 0.005);",
  "  float microAlpha = clamp(abs(microLightDelta) * 0.28 + abs(fieldCentered) * 0.009, 0.0, 0.022);",
  ...
  "  vec3 nebulaLightTint = vec3(0.18, 0.24, 0.40);",
  "  vec3 nebulaDarkTint = vec3(0.004, 0.008, 0.016);",
