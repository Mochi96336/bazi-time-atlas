...
console.log(`[ganzhi-inspector] PASS contextual Structure tabs + keyboard ownership + standalone reference targets without Selected-Instant mutation: ${fixture.url}`);