...
const captures = [
  {
    scenario:"editor-ordinary-visual",
    name:"annual-selected-instant-editor-1440x900.png"
  },
  {
    scenario:"editor-visual",
    name:"annual-tools-selected-instant-editor-1440x900.png"
  }
];
...
for (const capture of captures) {
  const fixtureURL = new URL(`scripts/fixtures/tools-human-ux.html?scenario=${capture.scenario}`, baseURL).href;
